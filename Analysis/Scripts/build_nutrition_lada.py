  ...
  <a href="Acronym_Database.html" style="color:#636363;text-decoration:none;">Acronyms</a>
    ...
    <div class="container">
        ...
        <div class="context-block">
            ...
            <p>LADA patients have both autoimmune and metabolic dysfunction. Nutritional strategies for LADA must address both — reducing autoimmune inflammation while supporting metabolic control. This dashboard evaluates evidence for LADA-specific nutritional interventions, which is nearly nonexistent because most nutrition studies in diabetes do not distinguish LADA from T2D.</p>
        ...
        <div id="tab2" class="tab-content">
            <div class="section">
                ...
                <ul>
                    <li><strong>PREDIMED Trial:</strong> Mediterranean diet reduced new-onset type 2 diabetes by 30% in high-risk individuals. <a href="https://pubmed.ncbi.nlm.nih.gov/25940230/" target="_blank">PMID:25940230</a> PREDIMED-Plus showed sustained prevention over 6+ years.</li>
        ...
        <div id="tab5" class="tab-content">
            <div class="section">
                ...
                <div class="reference">
                    ...
                    <div class="reference-meta">Salas-Salvado et al. PREDIMED. <a href="https://pubmed.ncbi.nlm.nih.gov/25940230/" target="_blank">PMID:25940230</a></div>
