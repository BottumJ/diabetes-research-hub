...
<body>
    <div class="container">
        ...
        <div id="landscape" class="tab-content active">
            ...
            <div class="stat-row">
                <div class="stat-box">
                    ...
                    <div class="stat-desc">Total islet transplant recipients with documented outcomes</div>
                </div>
                <div class="stat-box">
        ...
        <div id="geographic" class="tab-content">
            ...
            <div class="text-section">
                <p><strong>Market concentration:</strong> Over 90% of all islet transplants performed in just 5 countries: USA, Canada, UK, France, and Australia.</p>
            ...
            <div class="stat-row">
                ...
                <div class="stat-box">
                    ...
                    <div class="stat-desc">Medicare limited, private insurance often denies</div>
                </div>
            </div>
        ...
        <div id="demographic" class="tab-content">
            ...
            <div class="text-section">
                <p><strong>Black patients with T1D:</strong> Higher incidence of severe hypoglycemia, higher complications from long-standing disease, yet receive far fewer islet transplants proportionally.</p>
                <ul>
        ...
        <div id="evidence" class="tab-content">
            ...
            <div class="evidence-item">
                ...
                <div class="evidence-desc">Comprehensive data on 1,477 transplant recipients. Primary source for U.S. islet transplant outcomes, demographics, and centers. Published biennially in American Journal of Transplantation.</div>
            </div>
            ...
            <div class="evidence-item">
                ...
                <div class="evidence-desc">CDC, ADA publications document racial/ethnic disparities in T1D incidence, complications, and outcomes. Contextualizes disparities in transplant access as part of broader systemic inequities.</div>
            </div>
            ...
            <div class="evidence-item">
                ...
                <div class="evidence-desc">Rural Health Information Hub, HRSA data on specialist availability. Documents concentration of transplant expertise in major metro areas; travel burden quantified.</div>
            </div>

            <div class="evidence-item">
                <div class="evidence-title">Insurance Coverage Landscape</div>
                <div class="evidence-desc">CMS coverage decision history for islet transplant. Post-LANTIDRA approval (June 2023), coverage pathway clarified but still restrictive. Private payer denials common.</div>
            </div>
