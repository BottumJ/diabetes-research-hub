...
GAPS_DATA = [
    {
        ...
        'background': 'Gene therapy for T1D focuses on immune tolerance (CAR-Treg approaches, PMID:41468096). LADA shares autoimmune etiology but with slower beta cell destruction, potentially offering a wider therapeutic window. LADA affects ~10% of adults diagnosed as T2D (PMID:40737658). No gene therapy trials exist for LADA specifically.',
    ...
    },
    {
        ...
        'background': 'Stem cell-derived islets are in Phase 3 trials (Vertex). These require immunosuppression, specialized centers, and cost potentially >$500K/patient. Health equity research in diabetes focuses on access to insulin, CGM, pumps — but not yet on emerging investigational cell-derived therapies (which still require immunosuppression and are not yet proven curative in long-term follow-up). Disparities in diabetes outcomes by race, income, geography are well-documented.',
    ...
    },
    {
        ...
        'status': 'Background Research',
        'validation': 'BRONZE',
        'validation_summary': 'Emerging mechanism with preclinical data. CAR-Tregs reduce neuroinflammation in MS models. PROSPERO registered systematic review (CRD420251073207) for CAR-Treg therapy.',
        'sources': [
    ...
    },
    {
        ...
        'background': 'CAR-T therapy in oncology costs $373K-$475K per treatment. CAR-Treg for T1D is in early stages (PMID:41468096, 41567805). Oncology has begun addressing CAR-T access disparities (geographic, racial, insurance). Zero publications apply this thinking to diabetes immunotherapy.',
    ...
    },
    {
        ...
        'background': 'Drug repurposing reuses approved drugs (often generic, low-cost). Health equity in diabetes focuses on insulin affordability, access to newer drugs. The intersection — repurposing as an equity strategy — is unstudied. Generic metformin costs ~$4/month; novel GLP-1 agonists cost ~$1,000/month. Repurposing could bridge this gap.',
