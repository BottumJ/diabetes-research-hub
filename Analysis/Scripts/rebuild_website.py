...
<div class="cards">
  <div class="card">
    <div class="status live">Available</div>
    <h3>GKA in LADA (Under Review)</h3>
    <p>Can glucokinase activators preserve beta cell function during LADA decline? Biological plausibility assessment, the "accelerated burnout" concern, TTP399 counter-evidence. Gap #9 (UNDER REVIEW).</p>
...
<div class="cards">
  <div class="card">
    ...
    <p>Pilot analysis integrating public genomics, proteomics, and metabolomics datasets to identify novel biomarker candidates for diabetes subtypes.</p>
  </div>
  <div class="card">
    <div class="status upcoming">May 2026</div>
    <h3>Drug Repurposing Screen</h3>
    <p>Network pharmacology analysis identifying existing approved drugs with computational evidence for diabetes therapeutic potential.</p>
  </div>
</div>
</section>
