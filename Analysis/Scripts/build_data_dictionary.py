...
<div class="context-block">
  ...
  <p>Diabetes research uses specialized vocabulary spanning endocrinology, immunology, genetics, pharmacology, and health economics. This dictionary defines 116 medical terms in both plain English and technical language, organized by body system, with connections to the 15 research gaps and cited sources for each definition.</p>
  <div class="context-label">How to Use This</div>
  <p>For non-specialists: look up any term encountered in the dashboards and get a plain-language explanation. For researchers: verify precise medical definitions with cited sources. For the platform: provides a shared vocabulary that ensures consistency across all 29 dashboards.</p>
  <div class="context-label">What This Cannot Tell You</div>
  <p>Definitions reflect consensus usage as of March 2026 and may not capture emerging terminology. Some terms have different meanings in different clinical contexts — the definitions here are diabetes-focused. Normal ranges cited are general population values and may vary by age, sex, and ethnicity.</p>
</div>
'''
