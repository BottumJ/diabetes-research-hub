...
<div style="background:#ffffff;border-bottom:1px solid #e0ddd5;padding:8px 20px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;font-size:13px;display:flex;gap:16px;align-items:center;flex-wrap:wrap;">
  ...
  <a href="Acronym_Database.html" style="color:#636363;text-decoration:none;">Acronyms</a>
    ...
    <div class="context-block">
        ...
        <p>Glucokinase activators (GKAs) are a class of diabetes drugs that work by making the glucose sensor in beta cells more sensitive. Several are in clinical development for T2D, but their potential for repurposing across other diabetes contexts (LADA, post-transplant, monogenic diabetes) is unexplored. This dashboard maps the GKA development landscape and identifies repurposing opportunities.</p>
        <div class="context-label">How to Use This</div>
        <p>For pharma/biotech: identifies which GKA candidates have mechanisms most amenable to repurposing beyond T2D. For researchers: maps the gap between GKA clinical programs and unaddressed diabetes subtypes. For regulators: provides context on GKA safety signals and development status.</p>
        <div class="context-label">What This Cannot Tell You</div>
        <p>GKA clinical development is active and fast-moving; pipeline status may be outdated within months. Repurposing potential is scored computationally from mechanism analysis, not clinical evidence. Hypoglycemia risk — the main GKA safety concern — is not modeled at the individual patient level.</p>
    </div>
    ...
    <div id="tab1" class="content active">
        ...
        <p class="source">Source: PMID:30949058 (Matschinsky, Glucokinase as glucose sensor)</p>
    ...
    <div id="tab4" class="content">
        ...
        <ul>
            ...
            <li><strong>Preserved beta cell function:</strong> Some evidence (Gap #9, EXPLORATORY) suggests GKA-mediated metabolic stress reduction could extend beta cell survival</li>
