  ...
  <a href="Acronym_Database.html" style="color:#636363;text-decoration:none;">Acronyms</a>
    ...
    <div class="container">
        ...
        <div class="context-block">
            ...
            <p>Can specific nutrients protect beta cells from destruction? This dashboard synthesizes evidence on nutritional compounds (omega-3 fatty acids, vitamin D, polyphenols, fiber types) that have demonstrated effects on beta cell survival, function, or regeneration in preclinical and clinical studies. The goal is to identify which nutritional interventions have enough evidence to warrant formal clinical investigation.</p>
            <p class="context-label">How to Use This</p>
            <p>For nutritional researchers: identifies the highest-evidence dietary compounds for beta cell protection. For clinicians: provides evidence context for nutritional counseling in early diabetes. For patients: frames what is known versus speculated about diet and beta cell health.</p>
            <p class="context-label">What This Cannot Tell You</p>
            <p>BRONZE tier. Most nutritional intervention evidence is observational or from small trials with surrogate endpoints. Effect sizes are generally small and confounded by overall dietary patterns. Supplement doses used in studies may differ from dietary intake levels.</p>
        </div>
