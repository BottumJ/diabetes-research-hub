...
<body>
    ...
    <div class="container">
        <div class="context-block">
            ...
            <p>Diabetes research does not proportionally represent the populations most affected by diabetes. This dashboard quantifies the gap: which demographics are overrepresented in clinical trials, which are underrepresented, and what the downstream consequences are for treatment guidelines that may not generalize across populations.</p>
            <div class="context-label">How to Use This</div>
            <p>For trial designers: identifies specific demographic gaps to address in enrollment. For funders: quantifies the equity cost of current research distribution. For advocacy groups: provides data-backed arguments for representative research investment.</p>
            <div class="context-label">What This Cannot Tell You</div>
            <p>Representation data is derived from published trial demographics and may not capture unpublished or industry-internal enrollment data. "Representation" is defined by race, geography, and income tier — other dimensions of equity (disability, age extremes, comorbidity burden) are not fully modeled.</p>
        </div>
        ...
        <div id="socioeconomic" class="tab-content">
            ...
            <div class="section">
                ...
                <!-- Source: PMID:34763823 PMID:37356445 -->
                <div class="metric-grid">
                    <div class="metric-card">
                        <div class="metric-label">USA - Insulin Cost</div>
                        <div class="metric-value">$300-400 <span class="pmid"><a href="https://pubmed.ncbi.nlm.nih.gov/34763823/" target="_blank">[PMID:34763823]</a></span></div>
                    ...
                    <div class="metric-card">
                        ...
                        <div class="metric-value">$35-50 <span class="pmid"><a href="https://pubmed.ncbi.nlm.nih.gov/37356445/" target="_blank">[PMID:37356445]</a></span></div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="gap-col">0% (full cost ~$300-500/mo) <span class="pmid"><a href="https://pubmed.ncbi.nlm.nih.gov/34763823/" target="_blank">[PMID:34763823]</a></span></td>
                        </tr>
                        <tr>
                            <td><strong>CGM devices</strong></td>
                            <td>50-70% if prescribed</td>
                            <td>Limited access</td>
                            <td class="gap-col">0% (~$300/device <span class="pmid"><a href="https://pubmed.ncbi.nlm.nih.gov/34763823/" target="_blank">[PMID:34763823]</a></span> + supplies)</td>
                        </tr>
                        <tr>
                            <td><strong>Endocrinology visit</strong></td>
                            <td>80-90% covered</td>
                            <td>Covered but appointment scarcity</td>
                            <td class="gap-col">Out-of-pocket ~$150-250 <span class="pmid"><a href="https://pubmed.ncbi.nlm.nih.gov/34763823/" target="_blank">[PMID:34763823]</a></span></td>
                        </tr>
                        <tr>
            ...
            <div class="section">
                ...
                <div class="bar-chart">
                    <div class="bar-item">
                        ...
                        <div style="font-size: 0.85rem; color: #2d7d46; margin-bottom: 1rem;">
                            Smartphone access in high-income households (>100k annual income)
                        </div>
                        ...
                        <div style="font-size: 0.85rem; color: #8b6914; margin-bottom: 1rem;">
                            Smartphone access in middle-income households (30-50k annual income)
                        </div>
                        ...
                        <div style="font-size: 0.85rem; color: #8b2500;">
                            Smartphone access in low-income households (<20k annual income)
                        </div>
                    </div>
                </div>
            ...
            <div class="section">
                ...
                <div class="expandable" onclick="toggleExpand(this)">
                    ...
                    <div class="expandable-content">
                        ...
                        <p style="margin-top: 1rem;">Yet interventions addressing this—food subsidies, assured food access programs—are rarely studied as diabetes treatment modalities. Clinical trials focus on medications, not on the socioeconomic conditions that make medication adherence possible.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="section">
                ...
                <div class="expandable" onclick="toggleExpand(this)">
                    ...
                    <div class="expandable-content">
                        ...
                        <ul style="margin-left: 2rem; margin-top: 1rem; line-height: 1.8;">
                            <li><strong>US legislation:</strong> Insulin price caps ($35/month <span class="pmid"><a href="https://pubmed.ncbi.nlm.nih.gov/37356445/" target="_blank">[PMID:37356445]</a></span> copay for Medicare beneficiaries; broader caps proposed)</li>
